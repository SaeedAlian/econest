...
var (
	...
	ErrCreatePhoneNumber                 = errors.New("there was an error on creating phone number")
	...
	ErrUpdatePhoneNumber                 = errors.New("there was an error on updating phone number")
	...
	ErrDeletePhoneNumber                 = errors.New("there was an error on deleting phone number")
